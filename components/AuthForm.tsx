...
export default function AuthForm({ onLoginSuccess }: { onLoginSuccess: (user: any) => void }) {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-slate-950">
      <form onSubmit={handleSubmit} className="bg-slate-900 p-8 rounded-2xl border border-slate-700 w-80 shadow-2xl">
        ...
        />
        <button className="w-full bg-sky-600 py-3 rounded-xl font-bold hover:bg-sky-500 transition-all">
          {isLogin ? '로그인' : '신청하기'}
        </button>
